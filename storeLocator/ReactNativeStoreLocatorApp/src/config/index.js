...
export const ConfigProvider = ({ children }) => {
  ...
  const config = {
    ...
    appIdentifier: 'rn-storelocatorlistings-android',
    ...
    serverConfig: {
      collections: {
        listings: 'store_locator_listings',
        savedListings: 'store_locator_saved_listings',
        categories: 'store_locator_categories',
        filters: 'store_locator_filters',
        reviews: 'store_locator_reviews',
      },
    },
    onboardingConfig: {
