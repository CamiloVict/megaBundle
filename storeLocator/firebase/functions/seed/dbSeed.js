...
exports.performSeeding = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    await importCollectionFromFile('store_locator_categories')
    await importCollectionFromFile('store_locator_filters')
    await importCollectionFromFile('store_locator_listings')
