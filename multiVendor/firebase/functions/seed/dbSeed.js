...
exports.performSeeding = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    await importCollectionFromFile('vendor_categories')
    await importCollectionFromFile('vendor_filters')
    await importCollectionFromFile('vendors')
    await importCollectionFromFile('vendor_products')
