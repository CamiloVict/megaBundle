...
exports.performSeeding = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    await importCollectionFromFile('real_estate_categories')
    await importCollectionFromFile('real_estate_filters')
    await importCollectionFromFile('real_estate_listings')
